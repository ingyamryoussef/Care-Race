...
namespace test2
{
    class SportsCar : Car
    {
        ...
        public SportsCar( string brand_car, string colour, int seats_no, string fuel_type, bool extra_features, double carcost, double constantSpeed) : base(brand_car, colour, seats_no, fuel_type, carcost, constantSpeed)
        {
