...
namespace test2
{
    class IndyCar : Car
    {
        ...
        public IndyCar(double max_speed, string brand_car, string colour, int seats_no, string motortype, string fuel_type, string tires_type, string extra_features, double carcost,double constantSpeed) : base(max_speed, brand_car, colour, seats_no, motortype, fuel_type, carcost,constantSpeed)
        {
        ...
        {
            double maxspeed = 1.5 + constantSpeed;
